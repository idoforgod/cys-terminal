...
impl BrowserError {
    pub(crate) fn corrupt_state(message: impl Into<String>) -> Self {
        Self {
            code: BrowserErrorCode::CorruptState,
    ...
    pub(crate) fn unsupported_state_schema(message: impl Into<String>) -> Self {
        Self {
            code: BrowserErrorCode::UnsupportedStateSchema,
            message: message.into(),
        }
    }
    ...
    pub(crate) fn invalid_manifest(message: impl Into<String>) -> Self {
        Self {
            code: BrowserErrorCode::InvalidManifest,
            message: message.into(),
        }
    }
    ...
    pub(crate) fn runtime_integrity(message: impl Into<String>) -> Self {
        Self {
            code: BrowserErrorCode::RuntimeIntegrityFailed,
            message: message.into(),
        }
    }
    ...
    pub(crate) fn runtime_path(message: impl Into<String>) -> Self {
        Self {
            code: BrowserErrorCode::RuntimePathRejected,
            message: message.into(),
        }
    }

    pub(crate) fn authority_rejected(message: impl Into<String>) -> Self {
        Self {
            code: BrowserErrorCode::AuthorityRejected,
            message: message.into(),
        }
    }
