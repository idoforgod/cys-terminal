...
> 한국어 품질의 *정량 측정*(오너 음성으로의 클론 품질)은 아직 미수행 — 'supported(코드상 지원)'
...
★오너 1차 언어=한국어 → 기본 후보는 **Qwen CustomVoice(Sohee)** 또는 **Chatterbox Multilingual**.
